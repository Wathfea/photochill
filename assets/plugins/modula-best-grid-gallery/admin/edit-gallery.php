...
"></i></a>
						...
						<?php elseif($data["type"] == "hover-effect"): ?>
                            ...
                            <div class="text">
                               ...
                               <a class="all-effects" href="http://modula.greentreelabs.net/all-effects.html" target="_blank"><i class="mdi mdi-comment-alert-outline"></i> Click to see all available effects</a>
